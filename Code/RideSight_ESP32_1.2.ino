/*
 * RideSight — ESP32 (Arduino IDE)  ·  2-LED build
 * Two WS2812B LEDs on separate pins:
 *   right = GPIO5  (D5)
 *   left  = GPIO25 (D25)
 * (centre LED removed)
 *
 ...
 *   ARRIVE                   -> BOTH LEDs FLASH MAGENTA when distance < 200 m
 *   STRAIGHT                 -> nothing
 *
...
static void bootSelfTest() {
  ...
  for (CRGB col : seq) { ledLeft[0]=ledRight[0]=col; FastLED.show(); delay(250); }
